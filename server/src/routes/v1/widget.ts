    ...
    async (req, reply) => {
      ...
      return reply.send({
        ...
        theme: {
          ...
          launcher_size: settings.launcher_size,
          launcher_icon: settings.launcher_icon,
          header_style: settings.header_style,
          bubble_style: settings.bubble_style,
          panel_width: settings.panel_width,
          launcher_pulse: settings.launcher_pulse,
          primary_color_dark: settings.primary_color_dark,
          brand_avatar_url: settings.brand_avatar_url,
